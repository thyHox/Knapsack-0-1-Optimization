...
│   ├── BTBenchmark.py    # Benchmark de Backtracking (n, T = %sum(t)), con desviación estándar
...
│   │   ├── performance_leafnodesReduction.png  # Reducción de nodos hoja tras optimización
...
│   │   └── performance_greedy_BigN.png      # Greedy con n grande (escala de millones)
│   └── DP
